...
public class Producto {
	...
	@NotNull // Validación de la propiedad categoria para que no sea nula.En los objetos que no sean de tipo String la validación de que no sea nulo o vacío hay que hacerlo con la anotación @NotNull en vez de @NotEmpty
