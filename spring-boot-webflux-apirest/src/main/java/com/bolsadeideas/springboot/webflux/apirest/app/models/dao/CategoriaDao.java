...
public interface CategoriaDao extends ReactiveMongoRepository<Categoria,String>{
	...
	// Devuelve un flujo reactivo Mono con una categoría localizada en la base de datos cuyo nombre coincide con el que se le pasa como parámetro a este método
